        ...
        <div class="card shadow w-100">
            ...
            <div class="card-body">
                ...
                <div class="row align-items-center">
                    <div class="col-md-4"><?php echo $this->Form->input('Usuario.usuario', array('type'=>'text' ,'class'=>'form-control', 'label'=>'Nombre de Usuario'));?></div>
                ...
                <div class="row">
                    <div class="col-lg-4"><?php echo $this->Form->input('Usuario.grupo_id', array('class' => 'form-control','options' => $grupos,'empty' => '--Seleccione--'));?></div>
                    <div class="col-lg-4"><?php echo $this->Form->input('Usuario.area_id', array('class' => 'form-control','options' => $areas,'empty' => '--Seleccione--'));?></div>
                </div>
                <br>
