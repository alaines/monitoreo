    ...
    <div class="col-lg-12">
        <div class="card shadow w-100">
            <div class="card-header">
                <h6 class="m-0 font-weight-bold text-primary">Tipos : Editar</h6>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        ...
                        <?php echo $this->Form->input('parent_id',['label'=>'Categorias','options' => $categorias,'empty'=>[' - '],'class' => 'form-control']); ?>
                    </div>
                </div>
                <br>
                <div class="row">
