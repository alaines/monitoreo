<div class="proyectos index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('ejecutado_x_empresa'); ?></th>
			<th><?php echo $this->Paginator->sort('estado'); ?></th>
			<th><?php echo $this->Paginator->sort('ano_proyecto'); ?></th>
			<th><?php echo $this->Paginator->sort('created'); ?></th>
			<th><?php echo $this->Paginator->sort('usuario_registra'); ?></th>
			<th><?php echo $this->Paginator->sort('modified'); ?></th>
			<th><?php echo $this->Paginator->sort('usuario_modifica'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($proyecto['Proyecto']['ano_proyecto']); ?>&nbsp;</td>
		<td><?php echo h($proyecto['Proyecto']['created']); ?>&nbsp;</td>
		<td><?php echo h($proyecto['Proyecto']['usuario_registra']); ?>&nbsp;</td>
		<td><?php echo h($proyecto['Proyecto']['modified']); ?>&nbsp;</td>
		<td><?php echo h($proyecto['Proyecto']['usuario_modifica']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $proyecto['Proyecto']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $proyecto['Proyecto']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
