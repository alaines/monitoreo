 ...
 */
    ...
    public function ver($id = null) {
        ...
        $plataforma = $this->Tipo->listarTipos('plataforma');
        ...
        $this->set(compact('plataforma','ubigeos','ubigeo_actual', 'administradores', 'proyectos', 'tipo_gestion','tipo_control','tipo_comunicacion','tipo_cruce','tipo_estructura','tipo_operacion','vias'));
    }
 ...
 */
	public function add() {
		...
		$administradores = $this->Cruce->Administradore->find('list',['conditions'=>['estado' => true ],'order'=>'nombre ASC']);
		$proyectos = $this->Cruce->Proyecto->find('list',['fields' => ['id','nombre'],'conditions'=>['estado' => true ]]);
		$this->set(compact('plataforma','ubigeos', 'administradores', 'proyectos', 'tipo_gestion','tipo_control','tipo_comunicacion','tipo_cruce','tipo_estructura','tipo_operacion'));
	}
 ...
 */
	public function edit($id = null) {
        ...
        function busqueda() {
            ...
            $administradores = $this->Cruce->Administradore->find('list',['conditions'=>['estado' => true ],'order'=>'nombre ASC']);
            $proyectos = $this->Cruce->Proyecto->find('list',['fields' => ['id','nombre'],'conditions'=>['estado' => true ]]);
            $redes = ['0'=>'TODAS','291'=>'291','413'=>'413','1'=>'OTROS'];
            $this->set(compact('ubigeos','tipo_comunicacion','administradores','proyectos','redes'));
        }
        ...
        public function mapa() {
            $this->Cruce->recursive = -1;
            $lista = $this->Cruce->find('all', ['fields'=>['id','administradore_id','codigo','nombre','latitud','longitud'],'conditions'=>['estado' => true]]);
            foreach ($lista as $t) {
                $cruces[] = ['id'=>$t['Cruce']['id'], 'cruce'=>$t['Cruce']['nombre'], 'lat'=>$t['Cruce']['latitud'], 'lng'=>$t['Cruce']['longitud'], 'codigo'=>$t['Cruce']['codigo'], 'capa'=>$t['Cruce']['administradore_id']];
            }
            $this->set(compact('cruces'));
