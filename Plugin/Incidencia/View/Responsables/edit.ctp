    ...
    <div class="col-lg-12">
        <div class="card shadow w-100">
            <div class="card-header">
                <h6 class="m-0 font-weight-bold text-primary">Responsables : Registrar</h6>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        ...
                        <?php echo $this->Form->input('equipo_id', array('class' => 'form-control', 'empty' => '--Seleccione--')); ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-3">
                        <?php echo $this->Form->input('nombre', array('class' => 'form-control', 'type' => 'text')); ?>
                    </div>
                </div>
                <br>
                <div class="row">
