                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="<?php echo $this->webroot;?>intersecciones/cruces/view/<?php echo $cruce['Cruce']['id'];?>" data-original-title="Ver Cruce" data-toggle="tooltip" data-placement="bottom" class="edit"><i class="fa fa-eye"></i></a>
