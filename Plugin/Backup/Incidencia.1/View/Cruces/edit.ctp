    ...
    <div class="col-lg-12">
        <div class="card shadow">
            <div class="card-header">
                <h6 class="m-0 font-weight-bold text-primary">Cruces : Editar</h6>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <?php echo $this->Form->input('codigo', array('type' => 'text', 'class' => 'form-control')); ?>
                    </div>
                    <div class="col-lg-4"><?php echo $this->Form->input('nombre', array('class' => 'form-control'));?></div>
                    <div class="col-lg-4">
                        <?php echo $this->Form->input('busca', array('type' => 'text', 'class' => 'form-control', 'label' => 'Proyecto', 'value'=>$this->request->data['Proyecto']['nombre'].' - '.$this->request->data['Proyecto']['etapa']));?>
...
<?php echo $this->Html->script(array('incidencias/cruces-edit')); ?>