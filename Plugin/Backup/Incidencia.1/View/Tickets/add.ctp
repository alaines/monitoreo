    ...
    <div class="col-lg-12">
        <div class="card shadow w-100">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-3"><?php echo $this->Form->input('incidencia_nombre', array('class' => 'form-control', 'empty' => '--Seleccione--', 'label' => 'Incidencia', 'options' => $incidencias, 'required')); ?></div>
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-3"><?= $this->Form->input('reporte_fecha',['label'=>'Fecha de Reporte','type'=>'text','class'=>'form-control','placeholder'=>'dd-mm-yyyy','maxlength'=>10]) ?></div>
                </div>
                <div class="row">
                    <div class="col-lg-8">
