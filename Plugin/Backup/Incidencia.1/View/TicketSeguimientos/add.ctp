        ...
        <div class="card shadow w-100">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3"><?php echo $this->Form->input('estado_id', array('class' => 'form-control','empty' => '--Seleccione--', 'required')); ?></div>
                    <div class="col-lg-3"><?= $this->Form->input('reporte_fecha',['label'=>'Fecha de Seguimiento','type'=>'text','class'=>'form-control','placeholder'=>'dd-mm-yyyy','maxlength'=>10]) ?></div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
