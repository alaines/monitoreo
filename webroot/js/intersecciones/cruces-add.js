 ...
 */
        ...
        var mapAdd = L.map('map_add').setView([-12.08173, -77.02300], 18);
        ...
        function onMapClick(e) {
            marker = new L.marker(e.latlng, {draggable:'true',icon: trafficIcon}).bindPopup("<input type='button' value='Borrar Marcador' class='btn btn-info btn-sm marker-delete-button'/>");
